...
const snacks = [
  ...
  },
  {
    "snack": "burger",
    "name": "Big Orange Cat",
    "description": "Certamente uma exeriência inesquecível, comer um dos nossos hambúrgueres Big com o pão em formato de um gatinho laranginha.",
    "price": 20,
    "image": "https://imgur.com/tiiGWA8.jpg"
  },
  {
    "snack": "burger",
    "name": "Tradicional Gato preto",
    "description": "Simples porem diferente e saboroso, pão com gergelim e um gatinho preto super fofinho",
    "price": 13,
    "image": "https://imgur.com/MjXzUNK.jpg"
  },
  ...
  },
  {
    "snack": "pizza",
    "name": "GatoPiri",
    "description": "Uma das nossas expecialidades GatoPiri, com bastante gato e catupiri, certamente irá adorar .",
    "price": 32,
    "image": "https://imgur.com/BL22Icj.jpg"
  },
  ...
  {
    "snack": "drink",
    "name": "Pepsi com gatinho preto",
    "description": "Uma pepsi bem gelada para você se refrescar e com um gatinho de brinde.",
    "price": 10,
    "image": "https://a.imagem.app/bN4m3v.jpeg"
  },
  ...
  },
  {
    "snack": "ice-cream",
    "name": "GatoRvete ",
    "description": "Um delícoso sorteve de chocolate para refrescar no calor.",
    "price": 10,
    "image": "https://imgur.com/woIZaRp.jpg"
  }
]

async function main() {
  await prisma.snack.createMany({
    // declarar os dados de snacks
    data: snacks,
    skipDuplicates: true,
  })
}

// fazer a chamada da função main
main()
  .catch((error) => {
    console.error(error)
    process.exit(1)
